package com.mapbar.platform.common.aspect;

import com.mapbar.platform.common.Const;
import com.mapbar.platform.common.exception.business.TokenExpireException;
import com.mapbar.platform.common.exception.business.TokenRequiredException;
import com.mapbar.platform.common.utils.RedisUtil;


import com.mapbar.platform.common.utils.StringUtil;
...
public class LoginRequiredSupoort {
    ...
    @Pointcut("@annotation(com.mapbar.platform.common.aspect.LoginRequired)")
    @Order(1)
