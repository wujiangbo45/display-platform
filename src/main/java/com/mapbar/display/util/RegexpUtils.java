...
public final class RegexpUtils
{
    ...
    public static void main(String[] args)
    {
        ...
        // System.out.println(validateInfo("1.2", CAR_LENGTH_REGEXP));
        // System.out.println(validateInfo("11.2", CAR_LENGTH_REGEXP));
        // System.out.println(validateInfo("1.22", CAR_LENGTH_REGEXP));
        // System.out.println(validateInfo("111.2", CAR_LENGTH_REGEXP));
        // System.out.println(validateInfo("a.2", CAR_LENGTH_REGEXP));
        //System.out.println("====================>>" + validateInfo("122,123,", COMMA_NUMBER));
