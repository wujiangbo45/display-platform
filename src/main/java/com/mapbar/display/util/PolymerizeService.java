...
//            PolymerizeResult result = new PolymerizeResult();
//            // 聚合值大于1时，聚合坐标
...
//            List<PolymerizeResult> polymerizeResultList = new ArrayList<PolymerizeResult>();
...
////                        inDto.getLeftLatitude(), inDto.getLeftLongitude());
////            	// 聚合信息
////                List<PolymerizeResult> polymerizeResultList = polymerizeService.getPolymerizeResult(realTimePointList, numBits + 2);
